    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.PASS, "1234567887");
                ...
                configuration.addAnnotatedClass(Milk.class);
                configuration.addAnnotatedClass(SourCream.class);

                configuration.addAnnotatedClass(carrot.class);
                configuration.addAnnotatedClass(potato.class);
